...
var jspack = new JSPack(); ;
  ...
  END DEPENDENCIES
   */
  var BinData, BinFile, DataType, Log, PascalString, fs,
  ...
  exports.BinData = BinData = (function() {
    function BinData() {}
  ...
  Log = (function() {
    ...
    Log.output = function(method, data) {
      if (typeof exports !== "undefined" && exports !== null) {
        ...
        if (PSD.DEBUG) {
          return console[method]("[BinData]", data);
        }
      }
    };
  ...
  BinData.BinFile = BinFile = (function() {
    ...
    BinFile.prototype.eof = function() {
      return this.pos >= this.len;
    };

    BinFile.prototype.read = function(bytes) {
      var i, _i, _results;
      _results = [];
    ...
    BinFile.prototype.seek = function(amount, rel) {
      if (rel == null) {
        rel = true;
      }
      if (rel) {
    ...
    BinFile.prototype.readf = function(format) {
  ...
  BinData.Record = (function() {
    Record.prototype.endian = "native";
    ...
    Record.prototype.define = function() {};
    ...
    Record.prototype.readType = function(type, name, opts) {
      var item;
      if (opts == null) {
        opts = {};
      }
    ...
    Record.prototype.pad = function(bytes) {
  ...
  BinData.DataType = DataType = (function() {
    var opts;

    opts = {};

    DataType.prototype.defaults = {
      endian: "native",
      initialValue: null,
      length: null
    };

    DataType.prototype.data = null;

    function DataType(options) {
      if (options == null) {
        options = {};
      }
      this.opts = _.defaults(options, this.defaults, this.opts);
      this.e = (function() {
        switch (this.opts.endian) {
          case "native":
            return "@";
    ...
    DataType.prototype.read = function(data) {
      return this.data = data;
    };

    DataType.prototype.readFormat = function(format, file) {
      return this.data = file.readf(this.e + format);
    };

    DataType.prototype.assign = function(value) {
      return this.data = value;
    };

    DataType.prototype.clear = function() {
      return this.data = this.opts.initialValue;
    };

    DataType.prototype.isClear = function() {
      return this.data === this.opts.initialValue;
    };

    DataType.prototype.numBytes = function() {};

    DataType.prototype.snapshot = function() {
      return this.data;
    };
  ...
  BinData.Type.Bool = (function(_super) {
    ...
    Bool.prototype.read = function(data) {
      return this.readFormat("?", data);
    };

    Bool.prototype.numBytes = function() {
      return 1;
    };
  ...
  BinData.Type.Char = (function(_super) {
    ...
    Char.prototype.read = function(file) {
      var code;
      code = (function() {
        switch (this.opts.unsigned) {
          case true:
            return "B";
          default:
            return "b";
      ...
      return this.readFormat(code, file);
    };

    Char.prototype.numBytes = function() {
      return 1;
    };
  ...
  BinData.Record.registerType(["char", "int8"], function(name, opts) {
    if (opts == null) {
      opts = {};
    }
    return this.readType("Char", name, opts);
  });

  BinData.Record.registerType(["uchar", "uint8"], function(name, opts) {
    if (opts == null) {
      opts = {};
    }
  ...
  BinData.Type.Double = (function(_super) {
    ...
    Double.prototype.read = function(data) {
      return this.readFormat("d", data);
    };

    Double.prototype.numBytes = function() {
      return 4;
    };
  ...
  BinData.Type.Float = (function(_super) {
    ...
    Float.prototype.read = function(data) {
      return this.readFormat("f", data);
    };

    Float.prototype.numBytes = function() {
      return 4;
    };
  ...
  BinData.Type.Int = (function(_super) {
    ...
    Int.prototype.read = function(file) {
      var code;
      code = (function() {
        switch (this.opts.unsigned) {
          case true:
    ...
    Int.prototype.numBytes = function() {
      return 4;
    };
  ...
  BinData.Type.Long = (function(_super) {
    ...
    Long.prototype.read = function(data) {
      var code;
      code = (function() {
        switch (this.opts.unsigned) {
          case true:
      ...
      return this.readFormat(code, data);
    };

    Long.prototype.numBytes = function() {
      return 4;
    };
  ...
  BinData.Type.LongLong = (function(_super) {
    __extends(LongLong, _super);

    function LongLong() {
      return LongLong.__super__.constructor.apply(this, arguments);
    }
    ...
    LongLong.prototype.read = function(data) {
      var code;
      code = (function() {
        switch (this.opts.unsigned) {
          case true:
    ...
    LongLong.prototype.numBytes = function() {
      return 8;
    };
  ...
  PascalString = (function(_super) {
    ...
    function PascalString() {
      return PascalString.__super__.constructor.apply(this, arguments);
    }
  ...
  BinData.Type.Short = (function(_super) {
    ...
    Short.prototype.read = function(data) {
      var code;
      code = (function() {
        switch (this.opts.unsigned) {
          case true:
    ...
    Short.prototype.numBytes = function() {
      return 2;
    };
  ...
  BinData.Type.String = (function(_super) {
    ...
    String.prototype.read = function(data) {
      var code;
      code = "" + this.opts.length + "s";
      return this.readFormat(code, data);
    };

    String.prototype.numBytes = function() {
